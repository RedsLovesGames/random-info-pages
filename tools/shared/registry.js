...
export const TOOLBOX_REGISTRY = [
  ...
  {
    id: 'pdf', title: 'PDF & Documents', route: './pdf/', description: 'Organize, edit, convert, OCR, inspect, and export PDFs.',
    type: 'asset', privacy: 'On device', available: false, keywords: ['pdf', 'document', 'ocr'],
    actions: [
      action('merge', 'Merge PDFs', 'organize', ['merge pdf', 'combine pdf'], { accepts: ['pdf'] }),
      action('split', 'Split PDF', 'organize', ['split pdf'], { accepts: ['pdf'] }),
      action('reorder', 'Reorder Pages', 'organize', ['reorder pdf pages'], { accepts: ['pdf'], requiresSelection: true }),
      action('rotate', 'Rotate Pages', 'organize', ['rotate pdf', 'turn pages'], { accepts: ['pdf'] }),
      action('delete-pages', 'Delete Pages', 'organize', ['delete pdf pages', 'remove pages'], { accepts: ['pdf'], requiresSelection: true }),
      ...
      action('extract', 'Extract Pages', 'extract', ['extract pdf pages'], { accepts: ['pdf'], requiresSelection: true }),
      action('pdf-images', 'PDF to Images', 'convert', ['pdf to png', 'pdf to jpg'], { accepts: ['pdf'] }),
      action('images-pdf', 'Images to PDF', 'convert', ['jpg to pdf', 'png to pdf'], { accepts: ['image'] }),
      action('ocr', 'OCR', 'process', ['recognize text', 'searchable pdf'], { accepts: ['pdf', 'image'] }),
      action('compress', 'Compress PDF', 'process', ['compress pdf', 'reduce pdf size'], { accepts: ['pdf'] }),
