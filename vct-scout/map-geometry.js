(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;else root.MapGeometry=api;})(typeof self!=='undefined'?self:this,function(){
  'use strict';
  const C='template';
  ...
  addCommon('Lotus',{aMain:[.23,.72],aEntry:[.27,.56],siteA:[.27,.34],aLink:[.42,.42],bMain:[.54,.72],bEntry:[.53,.56],siteB:[.52,.36],bLink:[.56,.44],midLeft:[.41,.61],mid:[.49,.68],midRight:[.58,.61],flankLeft:[.31,.82],flankRight:[.69,.82],plantA:[.29,.37],plantB:[.52,.39],postA:[.20,.50],postB:[.59,.50]});
