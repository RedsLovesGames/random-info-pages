        ...
        >
                ...
                >
                    ...
                    >
                        ...
                        <div style={styles.headerInfo}>
                            ...
                            <p>RIP BIOS (C)2026 RANDOM INFO SYSTEMS</p>
                        </div>
                    </div>
                    <div style={styles.body} className="loading-screen-body">
                        <p>RIP/26 ARCHIVE COMPUTER · CRT GATEWAY</p>
                        <div style={styles.spacer} />
                        {showBiosInfo && (
                            <>
                                <p>Random Info Pages Archive(tm) 26</p>
            ...
            >
                <div style={styles.startPopup}>
                    ...
                    <div style={styles.spacer} />
                    <div style={styles.spacer} /> */}
                    <p>Random Info Computer · Archive Terminal 26</p>
                    {mobileWarning && (
                        <>
                            <br />
                            <b>
